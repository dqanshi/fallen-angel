...
async def play_commnd(
        ...
        if await YouTube.exists(url):
            ...
            try:
                ...
                await mystic.edit_text(
                    "sᴏᴍᴇᴛʜɪɴɢ ɪs ᴡʀᴏɴɢ ᴡɪᴛʜ ᴛʜᴇ ʙᴏᴛ. ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴛᴏ ᴍʏ ᴏᴡɴᴇʀ ᴀɴᴅ ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ sᴀʏ ʜɪᴍ ᴛʜᴀᴛ ᴄʜᴇᴄᴋ ʟᴏɢɢᴇʀ ɢʀᴏᴜᴩ."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "ᴩʟᴇᴀsᴇ ᴛᴜʀɴ ᴏɴ ᴠɪᴅᴇᴏᴄʜᴀᴛ sᴏ ᴛʜᴀᴛ ʙᴏᴛ ᴡɪʟʟ ᴀʙʟᴇ ᴛᴏ sᴛʀᴇᴀᴍ ɢɪᴠᴇɴ ᴜʀʟs.",
                )
            except Exception as e:
                return await mystic.edit_text(
    ...
    if str(playmode) == "Direct":
        ...
        if plist_type:
            ...
            return await play_logs(
                message, streamtype=f"ᴩʟᴀʏʟɪsᴛ : {plist_type}"
            )
        else:
            if slider:
                ...
                return await play_logs(
                    message, streamtype=f"sᴇᴀʀᴄʜᴇᴅ ᴏɴ ʏᴛ"
                )
            else:
                ...
                return await play_logs(
                    message, streamtype=f"ᴜʀʟ sᴇᴀʀᴄʜᴇᴅ ɪɴʟɪɴᴇ"
                )
...
async def anonymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "ʏᴏᴜ'ʀᴇ ᴀɴ ᴀɴᴏɴʏᴍᴏᴜs ᴀᴅᴍɪɴ\n\nɢᴏ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴩ sᴇᴛᴛɪɴɢ \n-> ᴀᴅᴍɪɴs \n-> ᴄʟɪᴄᴋ ᴏɴ ʏᴏᴜʀ ᴩʀᴏғɪʟᴇ \n-> ᴜɴᴄʜᴇᴄᴋ **ᴀɴᴏɴʏᴍᴏᴜs ᴀᴅᴍɪɴ** ᴏᴩᴛɪᴏɴ.",
            show_alert=True,
        )
    except:
        return
