...
async def useradd(client, message: Message, _):
    if MONGO_DB_URI is None:
        return await message.reply_text(
            "**ᴅᴜᴇ ᴛᴏ ʙᴏᴛ's ᴩʀɪᴠᴀᴄʏ ɪssᴜᴇs, ʏᴏᴜ ᴄᴀɴ'ᴛ ᴍᴀɴᴀɢᴇ sᴜᴅᴏ ᴜsᴇʀs ʙᴇᴄᴀᴜsᴇ ʏᴏᴜ ᴀʀᴇ ᴜsɪɴɢ ʀʏᴛʜᴍx ᴅᴀᴛᴀʙᴀsᴇ ғᴏʀ ʏᴏᴜʀ ʙᴏᴛ.\n\n ᴩʟᴇᴀsᴇ ғɪʟʟ MONGO_DB_URI ᴠᴀʀ ᴛᴏ ᴜsᴇ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ.**"
        )
...
async def userdel(client, message: Message, _):
    ...
    if not message.reply_to_message:
        ...
        if removed:
            ...
            return
        await message.reply_text(f"sᴏᴍᴇᴛʜɪɴɢ ᴡʀᴏɴɢ ʜᴀᴩᴩᴇɴᴇᴅ.")
        return
