    ...
    async def download(self, _, message, mystic, fname):
        ...
        async def down_load():
            ...
            async def progress(current, total):
                ...
                upl = InlineKeyboardMarkup([[InlineKeyboardButton(text="🧐 ᴄᴀɴᴄᴇʟ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ 🧐", callback_data="stop_downloading"),]])
...
**ᴇᴛᴀ:** {eta}"""
            ...
            try:
                ...
                await mystic.edit_text("ғɪʟᴇ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ, ᴛʀʏɪɴɢ ᴛᴏ ᴩʟᴀʏ ɪᴛ ɴᴏᴡ...")
